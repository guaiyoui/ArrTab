...
def init_distributed_mode(params):
    ...
    if params.is_slurm_job and has_local_rank:
        print(f"in slurm job: {params.is_slurm_job} and has local rank: {has_local_rank}")
    ...
    # multi-GPU job (local or multi-node) - jobs started with torch.distributed.launch
        ...
        print(f"in distributed job: {params.is_slurm_job} and has local rank: {has_local_rank}")
        ...
        print(f"in local job: {params.is_slurm_job} and has local rank: {has_local_rank}")
        print(f"params.world_size is {params.world_size}")
